            ...
            <div class="col-md-6 ">
                ...
                <div class="d-flex justify-content-center justify-content-md-start">
                    <form action="" method="post">
                        ...
                        <button id="reserve"  data-bs-toggle="modal" data-bs-target="#exampleModal" class="btn btn-outline-dark flex-shrink-0" type="button">
  ...
  <div class="modal-dialog ">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form>
          ...
          <div class="mb-3">
            ...
            <select
            class="form-select" aria-label="Default select example" name="timeEmprunt"
      ...
      <div class="modal-footer">
        ...
        <button type="button" id="confirmReservation" data-book-id="{{ $book->id }}" data-token="{{ csrf_token() }}" class="btn btn-primary">Confirm Reservation</button>
      </div>
    </div>
  </div>
</div>